...
import { Shield, AlertTriangle, CheckCircle, Wallet, HeartPulse, User, Info, Stethoscope, Activity, FilePlus, ChevronDown } from 'lucide-react';
...
export const InsuranceAnalysisView: React.FC<Props> = ({ data }) => {
  ...
  const ciBenchmark = annualIncome * 4;
